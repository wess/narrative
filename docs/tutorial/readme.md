...
2. **[Writing your first notes](writing.md)**
   Create pages, use the block editor and the slash menu, and learn the
   Markdown shortcuts.

3. **[Linking & the graph](linking.md)**
   Connect pages with `[[wiki links]]`, read backlinks, and explore the graph.

4. **[Organising a vault](organizing.md)**
   Folders, tags, daily notes, search, and templates — keeping a growing vault
   navigable.

5. **[Using the AI assistant](ai.md)**
...
A native window opens. That's your cue to begin with
